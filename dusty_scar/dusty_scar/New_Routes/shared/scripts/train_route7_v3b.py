...
DATA_DIR = Path("/workspaces/isaac_ros-dev/ws/src/Dusty-SCAR_ACC2026_Submission/dusty_scar/dusty_scar/New_Routes/Route7/combo/route7_combo_v3b")
LABELS = DATA_DIR / "labels.csv"
MODEL_OUT = Path("/workspaces/isaac_ros-dev/ws/src/Dusty-SCAR_ACC2026_Submission/dusty_scar/dusty_scar/New_Routes/Route7/models/route7_steer_v3b.pt")
