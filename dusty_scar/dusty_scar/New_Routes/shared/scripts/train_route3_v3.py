...
DATA_DIR = Path("/workspaces/isaac_ros-dev/ws/src/Dusty-SCAR_ACC2026_Submission/dusty_scar/dusty_scar/New_Routes/Route3/combo/route3_combo_v3")
LABELS = DATA_DIR / "labels.csv"
MODEL_OUT = Path("/workspaces/isaac_ros-dev/ws/src/Dusty-SCAR_ACC2026_Submission/dusty_scar/dusty_scar/New_Routes/Route3/models/route3_steer_v3.pt")
