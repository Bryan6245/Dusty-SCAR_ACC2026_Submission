...
DATA_DIR = Path("/workspaces/isaac_ros-dev/ws/src/Dusty-SCAR_ACC2026_Submission/dusty_scar/dusty_scar/New_Routes/Route4/combo/route4_combo_v5")
LABELS = DATA_DIR / "labels.csv"
MODEL_OUT = Path("/workspaces/isaac_ros-dev/ws/src/Dusty-SCAR_ACC2026_Submission/dusty_scar/dusty_scar/New_Routes/Route4/models/route4_steer_v5.pt")
