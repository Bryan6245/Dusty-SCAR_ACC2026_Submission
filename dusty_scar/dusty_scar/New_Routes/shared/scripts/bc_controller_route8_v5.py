...
MODEL_PATH = "/workspaces/isaac_ros-dev/ws/src/Dusty-SCAR_ACC2026_Submission/dusty_scar/dusty_scar/New_Routes/Route8/models/route8_steer_v5.pt"
...
def main():
    ...
    try:
        ...
        # Try to stop the car on exit; ignore errors if shutdown is already happening
        try:
            if rclpy.ok():
                cmd = Twist()
